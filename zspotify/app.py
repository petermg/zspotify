...
from const import TRACK, NAME, ID, ARTIST, ARTISTS, GENRES, ITEMS, TRACKS, EXPLICIT, ALBUM, ALBUMS, \
    OWNER, PLAYLIST, PLAYLISTS, DISPLAY_NAME, SEARCH_LIMIT
...
def search(search_term):
    ...
    params = {'limit': ZSpotify.get_config(SEARCH_LIMIT),
              'offset': '0',
              'q': search_term,
